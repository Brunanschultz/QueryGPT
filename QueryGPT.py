...
class QueryGPT:
    ...
    def generate_query(self, user_query: str, interactive: bool = False) -> dict:
        ...
        print(f"🧠 Intent detected: {workspace}")
        ...
        print(f"🔍 Column pruning complete")
        ...
        print(f"📝 Found {len(similar_samples)} similar query examples")
        ...
        try:
            ...
            print("\n🚀 Query executed successfully. First 5 results:")
            print(df.head(5))
